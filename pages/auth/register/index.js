        ...
        <div className="grid border w-1/2">
          <div className="my-auto">
            ...
            <form action="" className="w-1/2 grid mx-auto border-t-2 border-b-2 py-5">
              ...
              <input type="text" placeholder="Insert your name" className="h-12 border border-gray-400 w-full rounded-xl px-5" />
              ...
              <input type="number" placeholder="Insert your phone number" className="h-12 border border-gray-400 w-full rounded-xl px-5" />
